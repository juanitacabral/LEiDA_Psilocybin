...
switch htest
    case 'ttest' 
        ...
        for t=1:NC
           % [H,P,CI,STATS] =
           % ttest2(data(t,g1)',data(t,g2)',pthr,'both','unequal');   %%
           % changed to paired sample t-test %%%
           [H,P,CI,STATS] = ttest(data(t,g1)',data(t,g2)',pthr); 
           %[H,P,CI,STATS] = ttest(data(t,g1)',data(t,g2)', 'Tail', 'left');   %try tailed ttest for switching matrix
